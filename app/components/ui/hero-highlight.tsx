...
export const HeroHighlight = ({
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="pointer-events-none bg-dot-thick-indigo-500 dark:bg-dot-thick-indigo-800   absolute inset-0 opacity-0 transition duration-300 group-hover:opacity-100"
        style={{
